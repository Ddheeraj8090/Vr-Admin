      ...
      {data.map((item, index) => (
        <div key={index} className="container mx-auto">
          ...
          <div className="py-10">
            ...
            <div className="flex   place-items-center justify-center items-center place-content-center gap-0 pt-10">
              <div className="p-0">
                <img
            ...
            <div className="flex   place-items-center justify-center items-center place-content-center gap-0 pb-10">
              <div>
                <img
